## Patient Segmentation & Retention using MIMIC-IV Clinical Database (Demo 2.2)
...
**Source:** MIMIC-IV Clinical Database Demo (PhysioNet / AWS Open Data) 

**Access:** Open-access demo dataset (no credentials required)
